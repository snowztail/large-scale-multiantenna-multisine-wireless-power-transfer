%% * Initialize script for Figure 6
clear; close all; clc; setup; config_achievable_region;
...
save('data/wpt_achievable_region.mat');
...
savefig('results/wpt_achievable_region.fig');
